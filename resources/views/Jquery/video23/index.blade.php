...
<link rel="stylesheet" href="{{ asset("video23/css/main.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video23/img/black-cat.jpg")}}" alt="Black Cats Rules!">
            ...
            <a href="http://google.es" target="_blank" data-rrss="correoe">
                <img src="{{ asset("video23/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="http://google.es" target="_blank" data-rrss="snapchat">
                <img src="{{ asset("video23/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="http://google.es" target="_blank" data-rrss="twitter">
                <img src="{{ asset("video23/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video23/js/main.js")}}"></script>
</body>
