...
<link rel="stylesheet" href="{{ asset("video36/css/main.css")}}">
<link rel="stylesheet" href="{{ asset("video36/css/animate.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video36/img/black-cat.jpg")}}" alt="Black Cats Rules!">
...
<script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.4.1.min.js"></script>
    ...
    <script src="{{ asset("video36/js/main.js")}}"></script>
</body>
