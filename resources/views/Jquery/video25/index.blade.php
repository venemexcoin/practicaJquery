...
<link rel="stylesheet" href="{{ asset("video25/css/main.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video25/img/black-cat.jpg")}}" alt="Black Cats Rules!">
            ...
            <a href="http://google.es" target="_blank" data-rrss="correoe">
                <img src="{{ asset("video25/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="http://google.es" target="_blank" data-rrss="snapchat">
                <img src="{{ asset("video25/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="http://google.es" target="_blank" data-rrss="twitter">
                <img src="{{ asset("video25/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video25/js/main.js")}}"></script>
</body>
