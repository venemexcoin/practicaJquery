...
<link rel="stylesheet" href="{{ asset("video8/css/main.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video8/img/black-cat.jpg")}}" alt="Black Cats Rules!">

            <!-- Social -->
            <a href="#">
                <img src="{{ asset("video8/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="#">
                <img src="{{ asset("video8/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="#">
                <img src="{{ asset("video8/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video8/js/main.js")}}"></script>
</body>
