...
<link rel="stylesheet" href="{{ asset("video19/css/main.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video19/img/black-cat.jpg")}}" alt="Black Cats Rules!">

            <!-- Social -->
            <a href="#" data-rrss="correoe">
                <img src="{{ asset("video19/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="#" data-rrss="snapchat">
                <img src="{{ asset("video19/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="#" data-rrss="twitter">
                <img src="{{ asset("video19/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video19/js/main.js")}}"></script>
</body>
