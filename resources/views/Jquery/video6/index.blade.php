...
<link rel="stylesheet" href="{{ asset("video6/css/main.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video6/img/black-cat.jpg")}}" alt="Black Cats Rules!">

            <!-- Social -->
            <a href="#">
                <img src="{{ asset("video6/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="#">
                <img src="{{ asset("video6/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="#">
                <img src="{{ asset("video6/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video6/js/main.js")}}"></script>
</body>
