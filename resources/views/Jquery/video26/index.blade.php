...
<link rel="stylesheet" href="{{ asset("video26/css/main.css")}}">
<link rel="stylesheet" href="{{ asset("video26/css/animate.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video26/img/black-cat.jpg")}}" alt="Black Cats Rules!">
            ...
            <a href="http://google.es" target="_blank" data-rrss="correoe">
                <img src="{{ asset("video26/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="http://google.es" target="_blank" data-rrss="snapchat">
                <img src="{{ asset("video26/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="http://google.es" target="_blank" data-rrss="twitter">
                <img src="{{ asset("video26/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video26/js/main.js")}}"></script>
</body>
