...
<link rel="stylesheet" href="{{ asset("video21/css/main.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video21/img/black-cat.jpg")}}" alt="Black Cats Rules!">

            <input type="text" id="claim" maxlength="40" placeholder="Introduce tu titulo">

            <!-- Social -->
            <a href="#" data-rrss="correoe">
                <img src="{{ asset("video21/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="#" data-rrss="snapchat">
                <img src="{{ asset("video21/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="#" data-rrss="twitter">
                <img src="{{ asset("video21/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video21/js/main.js")}}"></script>
</body>
