...
<link rel="stylesheet" href="{{ asset("video20/css/main.css")}}">
</head>
...
<body>
    ...
    <main>
        ...
        <!-- Sidebar -->
        <aside class="lateral">
        <img src="{{ asset("video20/img/black-cat.jpg")}}" alt="Black Cats Rules!">

            <input type="text" id="claim" maxlength="40" placeholder="Introduce tu titulo">

            <!-- Social -->
            <a href="#" data-rrss="correoe">
                <img src="{{ asset("video20/img/mail.png")}}" alt="Correo-e">
                <span>Correo-e</span>
            </a>
            <a href="#" data-rrss="snapchat">
                <img src="{{ asset("video20/img/snapchat.png")}}" alt="Snapchat">
                <span>Snapchat</span>
            </a>
            <a href="#" data-rrss="twitter">
                <img src="{{ asset("video20/img/twitter.png")}}" alt="Twitter">
                <span>Twitter</span>
            </a>
    ...
    <script src="{{ asset("video20/js/main.js")}}"></script>
</body>
